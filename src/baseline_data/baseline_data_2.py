...
if __name__ == "__main__":
    ...
    (output / f"JBM170_HR_Day1-21_{SUSPECT_DATA_2.suspect_id}.json").write_text(
        SUSPECT_DATA_2.model_dump_json(indent=2)
    )
    print(f"Saved to processed/JBM170_HR_Day1-21_{SUSPECT_DATA_2.suspect_id}.json")